...
Sugarcane (गन्ना) - 70,000 kg/ha average
Groundnut (मूंगफली) - 3,500 kg/ha average
Maize (मक्का) - 6,000 kg/ha average
...
Functionality
Input Section: Soil parameters, crop selection, area
Weather Fetch: Real-time data retrieval
Prediction Display: Yield, economics, confidence
Recommendations: Actionable farming advice
Comparison Tool: Multi-crop analysis
...
Run crop_yield_prediction.py
Open yield_prediction_dashboard.html
Start predicting yields!


Empowering Farmers with AI for a Sustainable Future 🌾

Made by Vinotha S,Anushya S, Sowdeshwari S
Bannari Amman Institute of Technology
January 2026
